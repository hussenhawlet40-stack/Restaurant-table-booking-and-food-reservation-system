<?php
//view reviews with admin responses
session_start();
...
// Fetch all comments with ratings and reply counts
$comments_query = "
    SELECT c.*, 
...
<html>
<head>
    <title>Customer Reviews - Restaurant Booking</title>
...
<header>
    ...
    <nav>
        ...
        <a href="my_admin_responses.php"><i class="fas fa-reply-all"></i> My Responses</a>
...
<div class="mobile-nav" id="mobileNav">
    ...
    <a href="my_admin_responses.php">
        <i class="fas fa-reply-all"></i> My Responses
    </a>
...
<div class="container">
    <div class="page-header">
        ...
        <p class="page-subtitle">See what our customers are saying about their dining experience</p>
        ...
        <a href="my_admin_responses.php" class="write-review-btn" style="background: linear-gradient(45deg, #667eea, #764ba2); margin-left: 15px;">
    ...
    <div class="stats-card">
        ...
        <div class="rating-info">
            Average: <?= $avg_rating ?>/5 stars based on <?= $total_ratings ?> reviews
        </div>
    </div>
    <?php endif; ?>
                    ...
                    ?>
                        <div class="replies-section">
                            <div class="replies-header">
                                <i class="fas fa-reply-all"></i> 
                                Restaurant Response<?= count($replies) > 1 ? 's' : '' ?> (<?= count($replies) ?>)
                            </div>
